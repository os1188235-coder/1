  ...
  return (
    ...
    >
      ...
      <main id="antique_workspace" className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col">
        ...
        {/* Playable Battle Game Tab */}
        {activeTab === 'game' && (
          <div id="antique_game_viewport" className="w-full h-full flex-1">
            <GameScreen initialShowLeaderboard={false} />
          </div>
        )}

        {/* Read GDD specs Tab */}
        {activeTab === 'hall_of_fame' && (
          <div id="antique_leaderboard_viewport" className="w-full h-full flex-1 animate-fadeIn">
            <GameScreen initialShowLeaderboard={true} />
          </div>
        )}
